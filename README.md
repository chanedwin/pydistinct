...
Spang, B., & McKeown, N. On estimating the number of flows, 2019. Workshop on Buffer Sizing, Stanford University.
...
bootstrap(sequence=zipf["sample"],num_iterations=1000,stat_func=median_estimator,alpha=0.01)
>>> 214.4650115959957   (186.9877092688388, 241.31585930549633) # 271 is ground truth
bootstrap(sequence=zipf["sample"],num_iterations=1000,stat_func=smoothed_jackknife_estimator,alpha=0.01)
